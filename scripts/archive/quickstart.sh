#!/bin/bash
# Quickstart script for math-compact project
# This script demonstrates a complete workflow from dataset generation to training
...
# Step 2: Train model (small version for quick testing)
...
uv run -- python -m src.eval \
    --checkpoint runs/quickstart/checkpoint_best.pt \
    --data data/add/test.jsonl \
    --device cpu \
    --output metrics/quickstart_eval.json
